...
public abstract class Hilt_UpdateBudgetFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpdateBudgetFragment_GeneratedInjector) this.generatedComponent()).injectUpdateBudgetFragment(UnsafeCasts.<UpdateBudgetFragment>unsafeCast(this));
    }
  }
